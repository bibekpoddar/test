<html>
	...
	<div id="whole">
		<div id="header">
			...
			<br />-->
			<img src="styles/logo.png" class="curiosta" width="400px" height="75px" alt="BITS logo" />
		...
		<table>
			<div id="bottom">
				...
				<p class="descri">
				<strong>&nbsp;&nbsp;CURIOSTA INNOVATION LABS<br />
				...
				<img class="tagline" src="../styles/logo.png" width="300px" height="98px" alt="BITS_tagline" />
			</div>
		</table>
	</div>
